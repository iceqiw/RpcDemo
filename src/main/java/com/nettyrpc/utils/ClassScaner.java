...
public class ClassScaner {
     ...
     * logger
     */
    private static final Logger logger = Logger.getLogger(ClassScaner.class);


    private static ClassScaner instance = null;
    ...
    public static ClassScaner getInstance() {

        if (instance == null) {
            instance = new ClassScaner();
        }
        return instance;
    }
     ...
     * @param classFilters
     */
    public ClassScaner(Boolean excludeInner, Boolean checkInOrEx,
     ...
     */
    public ClassScaner setClassFilters(List<String> pClassFilters) {
    ...
    public static void main(String[] args) {
        ...
        ClassScaner handler = new ClassScaner(true, true,
                classFilters);
        ...
        calssList = handler.getPackageAllClasses("org.qiwei.app", true);
        for (Class<?> cla : calssList) {
            System.out.println(cla.getName());
        }
    }
